	...
	<div class="row">
        <div class="col-lg-12">
            <form class="form-horizontal" action="{{ url('author/conference/upload_manuscript') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="type" class="col-sm-2 control-label">Presentation Type</label>
                    <div class="col-sm-10">
                        <div class="radio radio-info radio-inline"><label><input type="radio" value="0" id="type" name="type" checked>Oral</label></div>
                        <div class="radio radio-info radio-inline"><label><input type="radio" value="1" id="type" name="type">Poster</label></div>
                    </div>
                </div>
                <div class="hr-line-dashed"></div>
                <div class="form-group">
