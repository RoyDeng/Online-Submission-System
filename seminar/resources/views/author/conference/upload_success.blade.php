	...
	<div class="row">
        <div class="col-lg-12">
            <div class="middle-box text-center">
                ...
                <a href="{{ url('author/conference') }}/{{ $conference -> number }}" class="btn btn-primary m-t">Back to Conferences</a>
            </div>
		</div>
	</div>
	<div class="footer">
...
<script>
    setTimeout("location.href='{{ url('author/conference') }}/{{ $conference -> number }}'", 10000);
</script>
@stop