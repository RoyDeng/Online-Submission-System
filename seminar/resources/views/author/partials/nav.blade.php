<nav class="navbar-default navbar-static-side" role="navigation">
	<div class="sidebar-collapse">
		<ul class="nav metismenu" id="side-menu">
			<li class="nav-header">
				<div class="dropdown profile-element"> <span>
					...
					<ul class="dropdown-menu animated fadeInRight m-t-xs">
						<li><a href="{{ url('author/profile') }}">Profile</a></li>
						<li class="divider"></li>
						<li><a href="{{ url('author/logout') }}">Logout</a></li>
					</ul>
				</div>
			...
			<li>
				<a href="{{ url('author') }}"><i class="fa fa-graduation-cap"></i> <span class="nav-label">Conferences</span></a>
			</li>
			<li>
				<a href="{{ url('author/conference/manuscripts') }}"><i class="fa fa-file"></i> <span class="nav-label">Conference Manuscripts</span></a>
			</li>
		</ul>
	</div>
</nav>
