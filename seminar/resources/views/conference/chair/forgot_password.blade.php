@section('title','Chair Forgot Password')
<!DOCTYPE html>
<html>
<head>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="ibox-content">
                    <h2 class="font-bold">Chair Forgot Password</h2>
                    <p>
                        Enter your email and your password will be reset and emailed to you.
                    </p>
                    <div class="row">
                        <div class="col-lg-12">
                            <form class="m-t" role="form" action="{{ url('conference/chair/reset_password') }}" method="post">
                                {{ csrf_field() }}
