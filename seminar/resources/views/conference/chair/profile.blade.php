                    ...
                    <div class="tab-content">
                        <div id="tab-6" class="tab-pane active">
                            <div class="panel-body">
                                <form class="form-horizontal" action="{{ url('conference/chair/edit_profile') }}" method="post">
                                    {{ csrf_field() }}
                        ...
                        <div id="tab-7" class="tab-pane">
                            <div class="panel-body">
                                <form class="form-horizontal" action="{{ url('conference/chair/change_password') }}" method="post">
                                    {{ csrf_field() }}
                                    <div class="form-group"></div>
                                    <div class="form-group">
