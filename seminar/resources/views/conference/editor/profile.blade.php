                    ...
                    <div class="tab-content">
                        <div id="edit-profile" class="tab-pane active">
                            <div class="panel-body">
                                <form class="form-horizontal" action="{{ url('conference/editor/edit_profile') }}" method="post">
                                    {{ csrf_field() }}
                        ...
                        <div id="security-settings" class="tab-pane">
                            <div class="panel-body">
                                <form class="form-horizontal" action="{{ url('conference/editor/change_password') }}" method="post">
                                    {{ csrf_field() }}
                                    <div class="form-group"></div>
                                    <div class="form-group">
