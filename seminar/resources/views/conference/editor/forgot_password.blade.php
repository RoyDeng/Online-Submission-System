@section('title','Editor Forgot Password')
<!DOCTYPE html>
<html>
<head>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="ibox-content">
                    <h2 class="font-bold">Editor Forgot Password</h2>
                    <p>
                        Enter your email and your password will be reset and emailed to you.
                    </p>
                    <div class="row">
                        <div class="col-lg-12">
                            <form class="m-t" role="form" action="{{ url('conference/editor/reset_password') }}" method="post">
                                {{ csrf_field() }}
                                <div class="form-group">
                                    <input type="email" class="form-control" placeholder="Email" name="email" required>
                                </div>
                                <input type="hidden" name="topic_id" vlaue="{{$topic -> id}}">
