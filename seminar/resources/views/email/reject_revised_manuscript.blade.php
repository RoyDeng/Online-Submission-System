                                ...
                                <table  cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td class="content-block">
                                            <h3>Notification about Rejecting Revised Manuscript {{ $manuscript_number }} for {{ $conference }}</h3>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="content-block">
                                            ...
                                            <p>Chair: {{ $chair_title }}{{ $chair_firstname }} {{ $chair_middlename }} {{ $chair_lastname }}</p>
                                    ...
                                    <tr>
                                        <td class="content-block">
                                            Your manuscript: {{ $manuscript_title }} has been rejected by the chair.
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="content-block">
